...
class UserGroups(db.Model):
    ...
    role = db.Column(db.Enum("member", "assistant", "owner"), nullable=False, default="member")  
    ...
    group = db.relationship("Groups", back_populates="user_groups", overlaps="members, assistants, owners, user_groups")  # overlaps added
